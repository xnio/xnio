...
final class BioUdpServer implements UdpServer {
    private static final Logger log = Logger.getLogger("org.xnio.nio.udp.bio-server");
    ...
    BioUdpServer(final NioXnio nioXnio, final Executor executor, final ChannelListener<? super MulticastMessageChannel> bindListener, final OptionMap config) {
        synchronized (lock) {
