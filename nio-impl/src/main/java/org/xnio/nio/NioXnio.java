...
public final class NioXnio extends Xnio {
    ...
    /** {@inheritDoc} */
    public TcpServer createTcpServer(final Executor executor, final ChannelListener<? super ConnectedStreamChannel> openListener, final OptionMap optionMap) {
        if (executor == null) {
    ...
    /** {@inheritDoc} */
    public Connector<ConnectedStreamChannel> createTcpConnector(final InetSocketAddress src, final OptionMap optionMap) {
        if (optionMap == null) {
            throw new NullPointerException("optionMap is null");
        }
        synchronized (lock) {
    ...
    /** {@inheritDoc} */
    public UdpServer createUdpServer(final Executor executor, final ChannelListener<? super MulticastMessageChannel> bindListener, final OptionMap optionMap) {
        if (executor == null) {
            throw new NullPointerException("executor is null");
        }
        if (optionMap == null) {
