...
import org.xnio.ssl.Ciphers;
import org.xnio.ssl.Encryption;
import org.xnio.ssl.OpenSSLCipherConfigurationParser;
...
import static org.xnio.ssl.Ciphers.SSL_RSA_WITH_RC4_128_MD5;
import static org.xnio.ssl.Ciphers.SSL_RSA_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_DHE_DSS_WITH_SEED_CBC_SHA;
import static org.xnio.ssl.Ciphers.TLS_DHE_RSA_WITH_SEED_CBC_SHA;
import static org.xnio.ssl.Ciphers.TLS_DH_anon_WITH_RC4_128_MD5;
import static org.xnio.ssl.Ciphers.TLS_DH_anon_WITH_SEED_CBC_SHA;
import static org.xnio.ssl.Ciphers.TLS_ECDHE_ECDSA_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_ECDHE_RSA_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_ECDH_ECDSA_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_ECDH_RSA_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_ECDH_anon_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_PSK_WITH_RC4_128_SHA;
import static org.xnio.ssl.Ciphers.TLS_RSA_WITH_SEED_CBC_SHA;
...
public class OpenSSLCipherConfigurationParserTest {
    ...
    public void testMoveToEnd() {
        ...
        movedCiphers.add(Ciphers.SSL_CK_IDEA_128_CBC_WITH_MD5);
    ...
    public void testDefaultSort() {
        ...
        assertEquals(expectedResult, displayResult(result, ":"));
    }
    /**
    ...
    public void testParseIntersection() {
        String expectedResult = "ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:SRP-RSA-AES-256-CBC-SHA:"
                + "DHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES256-SHA256:DHE-RSA-AES256-SHA:AES256-GCM-SHA384:AES256-SHA256:AES256-SHA:"
                + "ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:SRP-RSA-AES-128-CBC-SHA:"
                + "DHE-RSA-AES128-GCM-SHA256:DHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA:AES128-GCM-SHA256:AES128-SHA256:AES128-SHA";
        Set<Ciphers> result = OpenSSLCipherConfigurationParser.parse("AES+RSA");
        assertEquals(20, result.size());
        assertEquals(expectedResult, displayResult(result, ":"));
    }
    
    private static String displayResult(Set<Ciphers> ciphers, String separator) {
        if (ciphers.isEmpty()) {
            return "";
        }
