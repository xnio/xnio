 ...
 * <p>
 * To add an automatically-discovered XNIO provider type, create a file called {@code "META-INF/services/org.xnio.XnioProvider"}
...
public interface XnioProvider {
    ...
    /**
     * Get a provider instance, which may be shared.
     *
     * @return the new provider instance
     * @throws IOException if the new provider instance could not be created
     */
    Xnio getNewInstance() throws IOException;
}
