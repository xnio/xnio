...
final class SslEngineSslTcpServer implements AcceptingChannel<ConnectedSslStreamChannel> {
    ...
    private final ChannelListener.Setter<ConnectedSslStreamChannel> openSetter = new ChannelListener.Setter<ConnectedSslStreamChannel>() {
        public void set(final ChannelListener<? super ConnectedSslStreamChannel> channelListener) {
    ...
    public ChannelListener.Setter<? extends BoundChannel> getBindSetter() {
    ...
    public ChannelListener.Setter<? extends ConnectedSslStreamChannel> getOpenSetter() {
        return openSetter;
    }

    public Collection<? extends BoundChannel> getChannels() {
        return tcpServer.getChannels();
    }

    public IoFuture<? extends BoundChannel> bind(final InetSocketAddress address) {
