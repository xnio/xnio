 ...
 */
public final class FramingMessageSinkDuct extends AbstractSinkDuct<StreamSinkDuct> implements MessageSinkDuct {

    private final boolean longLengths;
    private final Pooled<ByteBuffer> transmitBuffer;

    public FramingMessageSinkDuct(final StreamSinkDuct next, final boolean longLengths, final Pooled<ByteBuffer> transmitBuffer) {
        super(next);
