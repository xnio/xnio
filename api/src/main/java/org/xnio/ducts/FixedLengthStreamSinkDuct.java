 ...
 */
public final class FixedLengthStreamSinkDuct extends AbstractStreamSinkDuct<StreamSinkDuct> implements StreamSinkDuct {
    private long remaining;

    public FixedLengthStreamSinkDuct(final FixedLengthStreamSinkDuct next) {
        super(next);
    }
