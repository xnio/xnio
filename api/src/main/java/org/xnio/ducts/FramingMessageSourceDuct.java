 ...
 */
public final class FramingMessageSourceDuct extends AbstractSourceDuct<StreamSourceDuct> implements MessageSourceDuct {
    private final Pooled<ByteBuffer> receiveBuffer;
    private boolean ready;

    public FramingMessageSourceDuct(final StreamSourceDuct next, final Pooled<ByteBuffer> receiveBuffer) {
        super(next);
