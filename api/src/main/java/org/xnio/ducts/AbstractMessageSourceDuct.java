 ...
 */
public abstract class AbstractMessageSourceDuct<D extends MessageSourceDuct> extends AbstractSourceDuct<D> implements MessageSourceDuct {

    protected AbstractMessageSourceDuct(final D next) {
        super(next);
    }
