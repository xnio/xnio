...
/**
 * A stream source duct which limits the length of input.
 *
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public final class FixedLengthStreamSourceDuct extends AbstractStreamSourceDuct<StreamSourceDuct> implements StreamSourceDuct {
    private long remaining;

    /**
     * Construct a new instance.
     *
     * @param next the duct to limit
     * @param remaining the number of bytes to limit to
     */
    public FixedLengthStreamSourceDuct(final StreamSourceDuct next, final long remaining) {
        super(next);
