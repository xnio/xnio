 ...
 */
public final class InflatingStreamSourceDuct extends AbstractStreamSourceDuct<StreamSourceDuct> implements StreamSourceDuct {

    private final Inflater inflater;
    private final ByteBuffer buffer;

    public InflatingStreamSourceDuct(final StreamSourceDuct next, final Inflater inflater) {
        super(next);
