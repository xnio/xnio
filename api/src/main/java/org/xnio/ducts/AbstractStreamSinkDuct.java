...
/**
 * An abstract base class for stream sink ducts.
 *
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public abstract class AbstractStreamSinkDuct<D extends StreamSinkDuct> extends AbstractSinkDuct<D> implements StreamSinkDuct {
     ...
     */
    protected AbstractStreamSinkDuct(final D next) {
        super(next);
    }
