...
/**
 * An abstract base class for stream source ducts.
 *
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public abstract class AbstractStreamSourceDuct<D extends StreamSourceDuct> extends AbstractSourceDuct<D> implements StreamSourceDuct {
     ...
     */
    protected AbstractStreamSourceDuct(final D next) {
        super(next);
    }
